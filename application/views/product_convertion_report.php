    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Product Conversion Report</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
				<form role="form" action="<?php echo base_url()?>productmixingrequisition/conversionproduct" method="post">
					<div class="col-md-4">
            ...
            <div class="col-xs-12 table-responsive">
              <table class="table table-striped table-bordered">
                  ...
                  <tr>
						...
						<th class="text-center">Converted Product</th>
                        <th class="text-center">Quantity.</th>
                        <th class="text-center">Rate</th>                        
                        <th class="text-center">Required Products</th>
				...
				?>
						<tr>                                
                                <td><?php echo ++$i;?></td>
                                <td align=""><?php echo $transection['stock_receive_date'];?></td>
                                <td align=""><?php echo $transection['referrence_number'];?></td>
                                <td align=""><?php echo $transection["product_description"];?></td>
                                <td align="right"><?php echo number_format($transection["quantity"],2).' kg';?></td>
                                <td align="right"><?php echo number_format($transection["rate"],2);?></td>
                                <td ><?php echo $transection["req_desc"]; ?></td>
