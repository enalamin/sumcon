...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>purchase/productwisepurchase" method="post">
                        <div class="col-md-3">
                ...
                <tbody>
                      ...
                      <?php
                        $i=0;
                            ...
                            foreach ($transectionData as $transection){
                                    ...
                                    $totalSalesAmaount += $transection['itemtotal'];
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td align="right"><?php echo $transection["quantity"].' '.$transection['product_unit'];?></td>
                                <td align="right"><?php echo $transection["unit_price"];?></td>
                                <td align="right"><?php echo number_format($transection["itemtotal"],2);?></td>
