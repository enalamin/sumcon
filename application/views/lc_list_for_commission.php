		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
						Sales
        				<small>LC List For Commission Calculation</small>
					</h1>
					<ol class="breadcrumb">
						<li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
						<li class="active">Sales</li>
        				<li class="active">LC List For Commission Calculation</li>
					</ol>
				</section>
	                  				...
	                  				<table id="example1" class="table table-bordered table-striped">
	                    				...
	                    				?>
	                            				<tr>
	                                				...
	                                				<td><a href="<?php echo base_url()?>sales/clculatelccommission/<?php echo $lc["lc_id"];?>" class="btn btn-block btn-primary">Calculate Commission</a></td>
	                            				</tr>
					                    <?php
					                            }
					                        }
