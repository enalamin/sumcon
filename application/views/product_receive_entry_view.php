...
<div class="wrapper">
	...
	<div class="content-wrapper">
		<!-- Content Header (Page header) -->
			...
			<h1>
				Purchase
                                <small>Product Receive entry</small>

			</h1>
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
				<li class="active">Purchase </li>
                                <li class="active">Product Receive entry</li>
			</ol>
		</section>
                ...
                <section class="content">
                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title">Product Receive Entry</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <form role="form"  action="<?php echo base_url()?>purchase/productreceive" method="post">
                        <div class="form-group">
							<div class="col-xs-4">
								<label>Receive Number</label>
								<input type="text" class="form-control" placeholder="Enter ..." name="orderNumber" value="<?php echo $receiveNumber;?>">
							</div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <textarea name="partyAddress" id="partyAddress" class="form-control" required></textarea>
                            </div>
                        </div>
       ...
       $("#datemask").datepicker();
        ...
        $("#party").change(function(){
            ...
            if(partyId>0){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url()?>party/getpartyaddress/'+partyId,
                    dataType: 'json',
                    complete: function(data){
                        var responses = data.responseText;
                        $("#partyAddress").val(responses);
                    }
                });
            }
            else
