...
<div class="wrapper">
	...
	<div class="content-wrapper">
		<!-- Content Header (Page header) -->
			...
			<h1>
				Sales
                                <small>Sales Return Entry</small>
				
			</h1>
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
				<li class="active">Sales </li>
                                <li class="active">Sales Return Entry</li>
			</ol>
		</section>
                ...
                <section class="content">
                    ...
                    <div class="box-body">
                        <form role="form"  action="<?php echo base_url()?>sales/salesreturn" method="post">
                        <div class="form-group">
                            <div class="col-xs-3">
                                <label>Sales Return Number</label>
                                <input type="text" class="form-control" placeholder="Enter ..." name="salesReturnNumber" value="<?php echo $salesReturnNumber; ?>">
                            </div>
                            <div class="col-xs-1">
                            </div>
                            <div class="col-xs-3">
       ...
       $("#datemask").datepicker();
        ...
        $("#btn_add").click(function(){
            ...
            if(product!='' && productQuantity!='' && productQuantity>0){
                $("#griddetails").append("<tr><td>"+productDescription+"</td><td>"+productQuantity+" "+productUnit+"</td><td>"+unitPrice+"</td><td>"+productPackage+"</td><td>"+productRmarks+"</td>"
                +"<td><input type='hidden' name='productid[]' value='"+product+"'><input type='hidden' name='productQty[]' value='"+productQuantity+"'><input type='hidden' name='productRate[]' value='"+unitPrice+"'><input type='hidden' name='productPackge[]' value='"+productPackage+"'><input type='hidden' name='productRemarks[]' value='"+productRmarks+"'></td></tr>");
                restproductrow();
                i++;
                $("#totalItemRow").val(i);
            }
