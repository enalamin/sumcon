...
<div class="wrapper">
	...
	<div class="content-wrapper">
        <?php
            if(is_array($collectionDetails) && !empty($collectionDetails))
            {
        ?>
		<!-- Content Header (Page header) -->
        <section class="content-header">
			<h1>Cheque Collection(<small>#<?php echo $collectionDetails[0]['collection_id']?></small>)</h1>
			<ol class="breadcrumb">
				<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
				<li><a href="#">Cheque Management</a></li>
				<li class="active">Cheque deposit to bank</li>
			</ol>
        </section>
        ...
        <section class="invoice">
			<!-- title row -->
			<form method="post" action="<?php echo base_url()?>chequemanagement/chequedeposit/<?php echo $collectionDetails[0]['collection_id'];?>">

				<div class="row ">
					<div class="col-xs-12 table-responsive text-center">
						<h3 style="text-decoration: underline;">Collection Details</h3>
					</div><!-- /.col -->
				</div><!-- /.row -->
				<div class="row ">
					<div class="col-xs-6 table-responsive">
						<b>Collection Number:</b> <?php echo $collectionDetails[0]['collection_no'];?><br>
					</div><!-- /.col -->
					<div class="col-xs-6 table-responsive">
						<b>Collection Date:</b> <?php echo $collectionDetails[0]['collection_date']?><br>
					</div><!-- /.col -->
				</div><!-- /.row -->
				<div class="row">
					<div class="col-xs-6 table-responsive">
						<b>Client Name:</b> <?php echo $collectionDetails[0]['client_name'];?><br>
					</div><!-- /.col -->
					<div class="col-xs-6 table-responsive">
						<b>Bank Name:</b> <?php echo $collectionDetails[0]['bank_name'];?><br>
					</div><!-- /.col -->
				</div><!-- /.row -->
				<div class="row">
					<div class="col-xs-6 table-responsive">
						<b>Cheque Number:</b> <?php echo $collectionDetails[0]['checque_no'];?><br>
					</div><!-- /.col -->
					<div class="col-xs-6 table-responsive">
						<b>Cheque Date:</b> <?php echo $collectionDetails[0]['checque_date'];?><br>
					</div><!-- /.col -->
				</div><!-- /.row  -->
				<div class="row ">
					<div class="col-xs-12 table-responsive text-center">
						<h3 style="text-decoration: underline;">Deposit TO Bank</h3>
					</div><!-- /.col -->
				</div><!-- /.row -->
				<div class="row">
