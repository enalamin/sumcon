                ...
                <div class="box">
	                ...
	                <div class="box-body">
	                  <table id="example1" class="table table-bordered table-striped">
	                    ...
	                    ?>
	                            <tr>
	                                <td><a href="<?php echo base_url();?>sales/moneyreceipt/<?php echo $collection["collection_no"];?>"><?php echo $collection["collection_no"];?></td>
	                                <td><?php echo $collection["client_name"]."[".$collection["client_id"]."]";?></td>

	                                <td><?php echo $collection["collection_date"];?></td>
	                                <td><?php echo $collection["collection_amount"];?></td>
