    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Free Sample Return</li>
          </ol>
        </section>
		  ...
		  <div class="invoice-info" style="margin-top:-20px;">
			<div class="row">
				<div class="col-xs-12" style="text-align: center;">
					<table align="center">
						<tr>
							<td><h2 class="printheadertitle">Sample Return</h2></td>
						</tr>
					</table>
				</div>
			</div>
					...
					<table class="table">
						<tr>
							...
							<td style="border: 1px solid;width:50%;">
                                ...
                                <b>Return Date:</b> <?php echo date('d-m-Y',strtotime($sampleDetails[0]['return_date'])); ?> <br>
              ...
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align:center;">used Quantity/Kgs/PCS</th>
                    <th style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align:center;">Return Quantity/Kgs/PCS</th>
                ...
                <tbody>
                     <?php
                        $i=0;
                        $grandTotal= $totalused=$totalReturn=0;
                    ...
                    ?>
							<tr>
                                ...
                                <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php echo number_format($sample["used_quantity"],2) ; ?> Kg</td>
                                <td style="border-left:1px solid;border-top:1px solid;text-align:right;"><?php echo number_format($sample["return_quantity"],2) ; ?> Kg</td>
                                <td style="border-left:1px solid;border-top:1px solid;border-right:1px solid;"><?php echo $sample["return_remarks"];?></td>
                            </tr>

                    <?php
                           $grandTotal += $sample["quantity"];
                           $totalused += $sample["used_quantity"];
                           $totalReturn += $sample["return_quantity"];
                            }
                    ...
                    <tr>
                                ...
                                <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align:right;"><?php echo number_format($totalused,2);?> Kg</td>
                                <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;text-align:right;"><?php echo number_format($totalReturn,2);?> Kg</td>
