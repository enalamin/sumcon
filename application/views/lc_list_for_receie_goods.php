		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
						Purchase
        				<small>LC List For Goods Receive</small>
					</h1>
					<ol class="breadcrumb">
						<li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
						<li class="active">Purchase</li>
        				<li class="active">LC List For Goods Receive</li>
					</ol>
				</section>
	                  				...
	                  				<table id="example1" class="table table-bordered table-striped">
	                    				...
	                    				?>
	                            				<tr>
	                                				...
	                                				<td><a href="<?php echo base_url()?>purchase/receivelcgoods/<?php echo $lc["lc_id"];?>" class="btn btn-block btn-primary">Receive Goods</a></td>
	                            				</tr>
					                    <?php
					                            }
					                        }
