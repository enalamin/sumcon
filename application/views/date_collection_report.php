    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Date Wise Collection</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>sales/datewisecollection" method="post">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                          <label>Collection Type</label>
                            <select name="collectionType" class="form-control select2">
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                                <td><?php echo ++$i;?></td>
                                <td align=""><?php echo $transection['collection_date'];?></td>
                                <td align=""><?php echo $transection["remarks"];?></td>
                                <td align=""><?php echo $transection["collection_type"];?></td>
