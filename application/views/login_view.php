...
<html>
  <head>
    ...
    <title>Sumcon Biotechnology | Log in</title>
      ...
      <div class="login-box-body">
        ...
        <?php
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="User Name" id="txt_username" name="txt_username">
