...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
        ...
        <section >
            <div class="box-body">
                <form role="form" action="<?php echo base_url()?>accounts/bankbook" method="post">
                  <div class="col-md-4">
        ...
        <section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo base_url(); ?>accounts/printbankbook<?php echo "/".$bankAccountDetails[0]['account_no'];?><?php echo isset($fromDate)?"/".date('Y-m-d', strtotime($fromDate)):"";?><?php echo isset($toDate)?"/".date('Y-m-d', strtotime($toDate)):"";?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
            </div>
          </div>
          <!-- info row -->
