			...
			<ol class="breadcrumb">
                ...
                <section class="content">
                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title">Product Loan Taken Entry</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <form role="form"  action="<?php echo base_url()?>productloantaken/loanCreate" method="post">
                        <div class="form-group">
                            <div class="col-xs-3">
                                <label>Loan Take Number</label>
                                <input type="text" class="form-control" placeholder="Enter ..." name="loanNumber" value="<?php echo $loanNumber; ?>">
                            </div>
                            <div class="col-xs-1">
                            </div>
                            <div class="col-xs-3">
                                <label>Loan Take Date</label>
