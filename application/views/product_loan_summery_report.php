...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
           Product Loan Summery Report
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Inventory</a></li>
            <li class="active">Product Loan Summery Report</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>productloangiven/productloansummery" method="post">
        ...
        <section class="invoice">
          ...
          <div class="row invoice-info">
            <div class="col-xs-12" style="text-align: center;">
					...
					<?php if ($clientId){ ?>
					<span>Party Name: <?php echo $clientDetails[0]['client_name'];?> </span>
					<?php } ?>
                ...
                <tbody>
                      ...
                      <?php
                        $i=0;
                            ...
                            foreach ($transectionData as $transection){
                                    $totalSalesQty += $transection['balance'];
									if($transection['balance']==0)
										continue;
                    ...
                    ?>
                            ...
                            <tr>                                
                                ...
                                <td align="right"><?php echo number_format($transection["balance"],2).' kg';?></td>
