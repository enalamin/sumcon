...
<html>
  <head>
    ...
    <title>Sumcon Biotechnology | Car expenses</title>
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Car Wise Expenses</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                <form role="form" action="<?php echo base_url()?>accounts/carexpenses" method="post">
                  <div class="col-md-4">
                    <label>Car</label>
                    <select class="form-control select2" name="car" id="car" required>
                    	<option value="">Select Car</option>
                      <?php
                      	if(is_array($carList)){
                        	foreach ($carList as $car){
                      ?>
                      			<option value="<?php echo $car["car_id"];?>"><?php echo $car["car_number"];?></option>
                      <?php
                      		}
                        }
                      ?>
        ...
        <section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo base_url(); ?>accounts/printcarexpenses<?php echo "/".$carDetails[0]['car_id'];?><?php echo isset($fromDate)?"/".date('Y-m-d', strtotime($fromDate)):"";?><?php echo isset($toDate)?"/".date('Y-m-d', strtotime($toDate)):"";?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
            </div>
          </div>
          <!-- info row -->
