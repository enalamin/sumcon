    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Date Wise Sample</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>freesample/datewisesample" method="post">
                        <div class="col-md-4">
					...
					<?php
                        $i=0;
                            ...
                            foreach ($transectionData as $transection){                                    
								$totalSalesAmaount += $transection['totalqty'];
								    
                    ?>
                       
                            <tr>                                
                                <td><?php echo ++$i;?></td>
                                <td align=""><?php echo $transection['sample_delivery_date'];?></td>
                                <td align=""><?php echo $transection["sample_number"];?></td>
                                <td align=""><?php echo $transection["client_name"];?></td>
                                <td align="right"><?php echo number_format($transection["totalqty"],2);?> </td>
