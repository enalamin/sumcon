			...
			<ol class="breadcrumb">
                ...
                <section class="content">
                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title">New Invoice Entry</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
      ...
      $(function () {
        ...
        $("#btn_add").click(function(){
            ...
            if(product!='' && productAmount!='' && productAmount>0){
                ...
                $("#griddetails").append("<tr><td>"+productDescription+"</td><td>"+productQuantity+"</td><td>"+productUnit+"</td><td>"+productPrice+"</td><td class='itemTotal'>"+productAmount+"</td>"
                +"<td><input type='hidden' name='productid[]' value='"+product+"'><input type='hidden' name='productQty[]' value='"+productQuantity+"'><input type='hidden' name='productPrice[]' value='"+productPrice+"'><button type='button' class='removebutton' title='Remove this row'>X</button></td></tr>");
                restproductrow();
                i++;
                $("#totalItemRow").val(i);
            }
