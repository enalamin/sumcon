    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Date Wise Payment</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>purchase/datewisepayment" method="post">
                        <div class="col-md-4">
            ...
            <div class="col-xs-12 table-responsive">
              <table class="table table-striped table-bordered">
                  ...
                  <tr>
						...
						<th class="text-center">Money Receipt No,</th>
					...
					<?php
                        $i=0;
                            ...
                            foreach ($transectionData as $transection){
								$totalSalesAmaount += $transection['pay_amount'];

                    ?>

                            <tr>
                                <td><?php echo ++$i;?></td>
                                <td align=""><?php echo $transection['payment_date'];?></td>
                                <td align=""><?php echo $transection["remarks"];?></td>
                                <td align=""><?php echo $transection["pay_type"];?></td>
                                <td align=""><?php echo $transection["client_name"];?></td>
                                <td align="right"><?php echo number_format($transection["pay_amount"],2);?></td>
