    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Accounts Ledger</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                <form role="form" action="<?php echo base_url()?>accounts/accountsledger" method="post">
                  <div class="col-md-4">
        ...
        <section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo base_url(); ?>accounts/printaccountsledger<?php echo "/".$accountHeadDetails[0]['accounts_head_id'];?><?php echo isset($fromDate)?"/".date('Y-m-d', strtotime($fromDate)):"";?><?php echo isset($toDate)?"/".date('Y-m-d', strtotime($toDate)):"";?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
            </div>
          </div>
          <!-- info row -->
                ...
                <tbody>
                    ...
                    <?php
                      ...
                      $totalCrAmount += $transection['crAmount'];
        							...
        							if($accountHeadDetails[0]['transection_type']=='Debit'){
        								$currentBalance += $transection['drAmount']-$transection['crAmount'];
        							}else{
        								$currentBalance += $transection['crAmount']-$transection['drAmount'];
        							}
                  ?>
                  <tr>
