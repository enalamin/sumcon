    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Receive Products</li>
          </ol>
        </section>
        ...
        <section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <!-- href="<?php echo base_url(); ?>/sales/printdeliverychallan/<?php echo $receiveDetails[0]['receive_number']?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a> -->
            </div>
          </div>
        </section><!-- /.content -->
        <?php
