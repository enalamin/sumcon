...
<div class="wrapper">
	...
	<div class="content-wrapper">
		<!-- Content Header (Page header) -->
			...
			<h1>
				Inventory
                                <small>Free Sample Entry</small>

			</h1>
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
				<li class="active">Inventory </li>
                                <li class="active">Free Sample Entry</li>
			</ol>
		</section>
                ...
                <section class="content">
                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title">Free Sample Entry</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <form role="form"  action="<?php echo base_url()?>freesample/sampleCreate" method="post">
                        <div class="form-group">
                            <div class="col-xs-3">
                                <label>Free Sample Number</label>
                                <input type="text" class="form-control" placeholder="Enter ..." name="sampleNumber" value="<?php echo $sampleNumber; ?>">
                            </div>
                            <div class="col-xs-1">
                            </div>
                            <div class="col-xs-3">
