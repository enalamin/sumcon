...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
           Product Loan Given Report
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Inventory</a></li>
            <li class="active">Product Loan Given Report</li>
          </ol>
        </section>
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>productloangiven/productloangivendetails" method="post">
                        <div class="col-md-3">
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>                                
                                <td><?php echo ++$i;?></td>
                                <td align=""><?php echo $transection['loan_given_date'];?></td>
