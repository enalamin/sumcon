                    	...
                    	<div class="col-md-12">
							<div class="box">
                				<div class="box-header">
		                  			<h3 class="box-title">Approve Sales Commission</h3>
				                </div><!-- /.box-header -->
				                <div class="box-body">
				                	<table id="example1" class="table table-bordered table-striped">
					                    ...
					                    ?>
					                            <tr>
					                                ...
					                                <td><a href="javascript:void(0);" class="btn btn-block btn-primary" onclick="approve(<?php echo $commission['client_id'];?>,'<?php echo $commission['refrenceNo'];?>')">Approve Commission</a></td>
					                           	</tr>
                    					<?php
					                            }
                        					}
...
<script>
    ...
    var approve = function(payeeId,refrenceNo){
		if(confirm("Do you want to approve the Commission?")){
			window.location="<?php echo base_url();?>sales/approvecommission/"+payeeId+"/"+refrenceNo;
		}
	}
