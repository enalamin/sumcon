...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Sales
        <small>Proforma Invoice List</small>
            ...
            <div class="col-md-12">
                <div class="box">
	                <div class="box-header">
	                  <h3 class="box-title">Proforma Invoice List</h3>
	                </div><!-- /.box-header -->
	                <div class="box-body">
	                  <table id="example1" class="table table-bordered table-striped">
	                    ...
	                    ?>
	                            <tr>
	                                ...
	                                <td><?php echo $lc["invoice_amount"];?></td>
	                                <td><?php echo $lc["status"];?></td>
	                                <td>
																		<?php
																			if($lc["status"]=='Not Ready'){
																		?>
																			<a href="<?php echo base_url()?>lcmanagement/senttobank/<?php echo $lc["lc_id"];?>" class="btn btn-block btn-primary">Sent to Bank</a>
																			<?php
																		} else if($lc["status"]=='Sent to Bank'){
																			?>
																			<a href="<?php echo base_url()?>lcmanagement/lcopen/<?php echo $lc["lc_id"];?>" class="btn btn-block btn-primary">LC Open</a>
																			<?php
																		}
