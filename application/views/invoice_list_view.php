		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
                ...
                <div class="box-header">
                  <h3 class="box-title">Sales Invoice List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>                                  
                                  ...
                                  <a href="<?php echo base_url(); ?>sales/viewinvoice/<?php echo $invoice["invoice_id"];?>" class="btn btn-block btn-primary">View Details</a></td>
