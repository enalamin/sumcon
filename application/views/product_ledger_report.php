...
<div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
        ...
        <section >
            <div class="box-body">
                        <form role="form" action="<?php echo base_url()?>product/productledger" method="post">
            ...
            <div class="col-xs-12 table-responsive">
              <table class="table table-striped table-bordered">
                  ...
                  <tr>
                        ...
                        <th class="text-center">Balance Rate.</th>
                ...
                <tbody>
                    <tr>                                
                                ...
                                <td align="right"><?php echo number_format($openingBalanceAmount,2);?></td>
                                <td align="right"><?php echo $openingBalance!=0?number_format(($openingBalanceAmount/$openingBalance),2):0; ?></td>
                      ...
                      <?php
                            ...
                            $totalinQty = $totaloutQty = 0;
							              $balanceQty = $openingBalance ;
                            $balanceAmount = $openingBalanceAmount;
                            $priviousBalanceQty = $previousBalanceAmount = $balanceRate = 0 ;
                    ...
                    ?>
                            ...
                            <tr>                                
                                <td><?php echo ++$i;?></td>
                                <td align=""><?php echo $transection['trn_date'];?></td>
                                ...
                                <td align="right"><?php echo number_format($transection["rate"],2);?></td>
                                <td align="right"><?php echo number_format($balanceQty,2). ' kg' ?></td>
                                <td align="right"><?php echo number_format($balanceAmount,2);?></td>
                                <td align="right"><?php echo $balanceQty>0?number_format(($balanceAmount/$balanceQty),2):number_format($transection["rate"],2); ?></td>
